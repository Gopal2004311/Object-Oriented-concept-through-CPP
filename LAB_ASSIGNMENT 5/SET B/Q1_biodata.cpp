...
void Personnel::acceptPerson()
{
    ...
    cout << "Enter full name(separate by underscore):";
    cin >> name;
    cout << "Enter Address:";
    cin >> adr;
...
void Academic::displayMarks()
{
    ...
    for (int i = 0;i < 9;i++)
    {
        int length = strlen(tenthMarks[i].subject);
        int actual = lengthTenth - length;
    ...
    for (int i = 0;i < no_of_subjects;i++)
    {
        int length = strlen(twelthMarks[i].subject);
        int actual = lengthTwelth - length;
